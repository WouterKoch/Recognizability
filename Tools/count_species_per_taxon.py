...
def count_species_per_taxon(encoding, sep, output_file, grouping_csv, language):
    ...
    print(os.getenv("TAXONOMY_DIR"))

    for root, dirs, files in os.walk(os.getenv("TAXONOMY_DIR")):
        for file in files:
